...
class ChooseSkillsActivity : AppCompatActivity() {
    ...
    var skill_list : MutableList<String> = mutableListOf(
        "Occupations",
        "Accountant",
        "Accounts Assistant",
        "Accounts Clerk",
...
//        "Zoologist"
    ...
    var checked_skills : ArrayList<String> = arrayListOf()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_choose_skills)

        checked_skills = intent.getStringArrayListExtra("skills") ?: arrayListOf()
